...
from edenlab.repository.import_data import (
    DEFAULT_LANG,
    DEFAULT_KEYWORD,
    DEFAULT_IMPORT_FIELDS
)
from edenlab.repository.import_data import import_data as data_import
...
def import_data(keyword, lang, fields):
    ...
    try:
        data_import(keyword, lang, fields.split(','))
    except Exception:
